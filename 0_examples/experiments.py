...
from utils.globals import pb, fa, NUM_CLIENTS, PATH_TO_SAVED_RESULTS
...
def run_normal_vs_neuromorphic_single():
    batches_mnist_dataset = load_mnist_batches()
    ...
    loaded_normal_results = json_manager.load_from_json(normal_results_fp)
    loaded_neuromorphic_results  = json_manager.load_from_json(neuromorphic_results_fp)

    print("Normal  Loaded results", loaded_normal_results)
    print("Neuromorphic Loaded results", loaded_neuromorphic_results)
...
run_normal_vs_neuromorphic_single()
